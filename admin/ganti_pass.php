...
if(isset($_GET['pesan'])){
	...
	if($pesan=="gagal"){
		...
		echo "<div class='alert alert-warning'>Password yang anda masukkan tidak sama !!     silahkan ulangi !! </div>";
	}else if($pesan=="oke"){
		echo "<div class='alert alert-success'>Password yang anda masukkan telah berhasil . Selamat </div>";
	}
}
?>
