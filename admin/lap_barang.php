...
$pdf->Image('../admin/foto/tokodata.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'MIF A Polije',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Mastrip',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website :Polije email : obito607@gmail.com',0,'L');
